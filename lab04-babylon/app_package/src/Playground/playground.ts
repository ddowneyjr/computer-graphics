...
class Playground {
    ...
    public static buildCircle (count: number, radius: number, scene: BABYLON.Scene): BABYLON.Mesh{
    ...
    public static buildBox(width: number, pos_x: number, scene: BABYLON.Scene): BABYLON.Mesh{
    ...
    public static buildRoof(width: number, pos_x: number, scene: BABYLON.Scene): BABYLON.Mesh{
    ...
    public static buildHouse(width: number, pos_x: number, scene: BABYLON.Scene): BABYLON.Mesh{
